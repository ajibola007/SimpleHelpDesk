    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="repair_list.php">AceTech Admin</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="repair_status.php"><i class="fa fa-fw fa-user"></i>   REPAIR REQUEST</a>
                    </li>

                    <!-- <li>
                        <a href="request_status.php"><i class="fa fa-fw fa-wrench"></i>   VIEW REQUEST</a>
                    </li> -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- View all accounts in the tables for users and technicians-->
