        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="remove_user.php"><i class="fa fa-fw fa-wrench"></i>   REMOVE USERS</a>
                    </li>
                    <li>
...
<button  type="btn-nav btn-danger" name="button" ><span class="glyphicon glyphicon-edit"></span>Remove User</button>
</form>
<?php
