    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">AceTech Admin</a>
            </div>
            <!-- Top Menu Items -->
...
<div class="form-group row">
  <label for="example-text-input" class="col-2 col-form-label">Technician's Username</label>
  <div class="col-xs-3">
...
<div class="form-group row">
  <label for="example-text-input" class="col-2 col-form-label">Customer's Username</label>
  <div class="col-xs-3">
    <input class="form-control" type="text" value="" name="username" id="example-text-input">
  </div>
</div>

<button name="submit" class="btn btn-primary btn-sm">MAP TECHNICIAN TO USER</button>
</form>
<?php
 //    include_once "../connection/dbconn.php";
   $servername = "localhost";
            ...
            if(isset($_POST['submit']))
    {
        ...
        $data = "UPDATE repair SET (username = ''), (assign_tech = '$assign_tech')";
                 
        if($connect->exec($data)){
            echo "<script> alert('Technician have been assigned to user successfully') </script>";
        }
    }
